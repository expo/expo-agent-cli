...
describe(startRuntimeFixture, () => {
  it('should require a real reload call, discover the lock, and release both listeners', async () => {
  ...
  it('should expose a captured bundler diagnostic and refuse to reload a broken bundle', async () => {
    const root = copyFixture('e2e/fixtures/go-app');
    let fixture: Awaited<ReturnType<typeof startRuntimeFixture>> | undefined;
    try {
