...
describe('Copying and snapshotting eval workspaces', () => {
  const roots: string[] = [];
  ...
  it('should start each attempt from an isolated fixture, with no successful outcome already present', () => {
  ...
  it('should run a fresh project against real locked packages without copying node_modules', () => {
  ...
  it.skipIf(process.platform === 'win32')(
    'should snapshot project files without reading a live Unix socket',
    async () => {
  ...
  it('should not copy a fixture outside this package', () => {
