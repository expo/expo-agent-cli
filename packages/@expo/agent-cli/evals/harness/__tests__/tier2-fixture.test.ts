...
describe('Preparing the Tier 2 fixture', () => {
  it('should accept only the intended Metro module resolution failure', () => {
    expect(() =>
  ...
  it('should isolate home and strip ambient account/agent settings', () => {
  ...
  it('should ship an exact SDK57 dependency graph including the web runtime and integrity hashes', () => {
