...
Tier 2 uses ordinary Vitest with its own E2E lifecycle and evidence files; it no longer depends
on Sentry's harness or reporter. The published Expo kit is used for Tier 1. Tier 2 remains a
separate draft pending the dedicated E2E harness and a credential-backed full agent run.
