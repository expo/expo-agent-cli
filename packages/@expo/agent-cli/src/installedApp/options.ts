...
export interface InstalledAppOptions {
  ...
  /**
   * Only the simulator, emulator or device matching this name or identifier.
   *
  ...
  /** How long a physical iOS device gets to report its fingerprint once the app was launched. */
  timeoutMs: number;
}
