...
import { event as eventFn } from '../../events';
import { runTypeCheckAsync as runTypeCheckAsyncFn } from '../checkAsync';

const event = vi.mocked(eventFn);
const runTypeCheckAsync = vi.mocked(runTypeCheckAsyncFn);
