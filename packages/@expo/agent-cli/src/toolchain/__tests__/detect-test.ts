...
import { spawnCaptureAsync as spawnCaptureAsyncFn } from '../../utils/spawnCapture';
...
const spawnCaptureAsync = vi.mocked(spawnCaptureAsyncFn);
...
vi.mock('os', async (importOriginal) => {
  ...
  const mocked = { ...os, homedir: () => '/home/dev' };
